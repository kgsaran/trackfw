...
features:
  ...
  - icon: 🤖
    ...
    details: '"trackfw context --format=json" emits full LLM context. Codex gets native AGENTS.md, skills, subagents, and hooks; Claude Code, Gemini CLI, and Cursor are also supported.'
  - icon: 🌐
    title: Multi-stack
