...
features:
  ...
  - icon: 🤖
    ...
    details: '"trackfw context --format=json" emite o contexto completo para LLMs. Codex recebe AGENTS.md, skills, subagentes e hooks nativos; Claude Code, Gemini CLI e Cursor também são suportados.'
  - icon: 🌐
