...
## Acceptance Criteria
- [ ] O job `parity` de `.github/workflows/quality.yml` roda `make parity` diretamente (ou uma
...
- [ ] Medir o tempo real de execução de `make parity` completo (incluindo os 100 cenários de
      ...
      não preventivamente
- [ ] `release.yml` também reavaliado: decidir explicitamente se o subconjunto reduzido de scripts
...
- [ ] Nenhum gate existente (incluindo os 10 hoje fora do CI) pode ficar permanentemente vermelho
