...
## Context
<!-- Derived from REQ: REQ-2026-09-02-remover-a-entrada-pretooluse-do-settings-nao-e-detectado-por-nenhuma-regra-de-integridade-de-guard.md -->
REQ: docs/req/REQ-2026-09-02-remover-a-entrada-pretooluse-do-settings-nao-e-detectado-por-nenhuma-regra-de-integridade-de-guard.md
...
### ML-1A — **AC1** — Remover a entrada hooks.PreToolUse do config é **detectado**, com severidade
**Status:** ⬜ Pendente
**Files affected:**
**Actions:**
**Acceptance criteria:**
...
### ML-1B — **AC2** — 🔴 **Detectar a ausência exige saber o que deveria existir.** A regra precisa de uma
**Status:** ⬜ Pendente
**Files affected:**
**Actions:**
**Acceptance criteria:**
...
### ML-1C — **AC3** — 🔴 **Falsificação nas duas direções.** (a) config com a fiação removida → detectado;
**Status:** ⬜ Pendente
**Files affected:**
**Actions:**
**Acceptance criteria:**
...
### ML-1D — **AC4** — Distinguir **"nunca instalado"** de **"instalado e removido"**. São fatos
**Status:** ⬜ Pendente
**Files affected:**
**Actions:**
**Acceptance criteria:**
...
### ML-1E — **AC5** — 🔴 **A assimetria do 6.3 endereçada ou declarada.** O hefesto-tf achou, lendo
**Status:** ⬜ Pendente
**Files affected:**
**Actions:**
**Acceptance criteria:**
